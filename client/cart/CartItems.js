...
export default function CartItems(props) {
  ...
  const handleChangeGiftComment = (index) => (event) => {
    let updatedCartItems = cartItems;
    if (event.target.value == 0) {
      updatedCartItems[index].giftComment = "";
    } else {
      updatedCartItems[index].giftComment = event.target.value;
    }
    setCartItems([...updatedCartItems]);
    cart.updateCartGift(index, null, event.target.value);
  };
  ...
  const giftItem = (index) => (event) => {
    let updatedCartItems = cartItems;
    if (event.target.value) {
      updatedCartItems[index].gift = true;
    } else {
      updatedCartItems[index].gift = !updatedCartItems[index].gift;
    }
    setCartItems([...updatedCartItems]);
    cart.updateCartGift(index, updatedCartItems[index].gift);
  };
  const openCheckout = () => {
  ...
  return (
    <Card className={classes.card}>
      ...
      {cartItems.length > 0 ? (
                    ...
                    <div className={classes.details}>
                      ...
                      <div className={classes.subheading}>
                        ...
                        {item.gift?
                          ...
                          {" "}Comment:
                          <TextField
                            value={item.giftComment}
                            onChange={handleChangeGiftComment(i)}
                            type="text"
                            inputProps={{
                              min: 1,
                            }}
        ...
        <Typography variant="subtitle1" component="h3" color="black">
